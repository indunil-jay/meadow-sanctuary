...
import { TBooking, TStaysAfterDate } from "../../services/apiBookings";
import {
  Cell,
  Legend,
  Pie,
...
// Initial data for the chart in light mode
...
// Initial data for the chart in dark mode
...
function prepareData(
  startData: ChartData[],
  stays: (TBooking & TStaysAfterDate)[]
): ChartData[] {
  const incArrayValue = (arr: ChartData[], field: string): ChartData[] => {
    return arr.map((obj) =>
...
type DurationChartProps = {
  confirmedStays: (TBooking & TStaysAfterDate)[];
};
